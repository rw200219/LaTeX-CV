...
\section{Technical Skills}
        ...
        \begin{onecolentry}
            \textbf{Cybersecuirty Tools:} Wireshark, packet analysis, network security protocols (TCP/IP, HTTP/HTTPS)
        \end{onecolentry}
...
\end{twocolentry}
 ...
 \vspace{0.05 cm}
    ...
    \begin{twocolentry}{ October 2024
            ...
            \textbf{Customised LaTeX Curriculum Vitae: \href{https://github.com/rw200219/LaTeXCV}{https://tinyurl.com/5d6kewkm}}\end{twocolentry}
...
\section {Extracurricular Education and Achievements} 
 ...
 \section{Interests and Volunteering}
        ...
        \begin{onecolentry}
            \textbf{Supported children with mental and physical disabilities in the School Games at St James’ Park, Newcastle:} Facilitated their participation in adapted sporting activities, ensuring enthusiasm, inclusivity, and accessibility for all. 
        \end{onecolentry}
          \vspace{0.05 cm}
...
\vspace{0.2 cm}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Working in customer service allowed me to develop and effectively communicate complex ideas in a clear and concise manner, facilitating seamless collaboration with team members and customers. 
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item Demonstrate strong organisational skills by effectively managing time to complete projects ahead of deadlines to reduce stress and workloads during my university career. 
